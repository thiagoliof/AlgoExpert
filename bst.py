...
class BinarySearchTree:
  ...
  def find_in_order_successor(self, inputNode):
    ...
    ##########################
    # verifica se tem pra direita, pois a direita é maior
    if not inputNode.right is None:
    ...
    while (not ancestor is None and child == ancestor.right):
      child = ancestor
  ...
  def findMinKeyWithInTree(self, inputNode):
    while (not inputNode.left is None):
